...
def main():
    ...
    for i in range(0, env.nnodes):
        ...
        agent_list.append(
            networkTabularQAgent(env.nnodes, env.nedges, i, env.nlinks, env.links, env.link_num, env.dests, n_features,
                                 learning_rate, num_layers, layer_sizes, layer_types, mean_val, std_val, constant_val,
                                 act_func))
